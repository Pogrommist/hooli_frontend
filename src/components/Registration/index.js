    ...
    <div className='site-background'>
      <form className="registration-form" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="registration-form__inputs">
          <Input name="first_name" required register={register} placeholder="First name" hasError={errors.first_name} />
          <Input name="last_name" required register={register} placeholder="Last name" hasError={errors.last_name} />
          <Input type="email" name="email" required register={register} placeholder="E-mail" hasError={errors.email} />
          <Input type="password" name="password" required register={register} placeholder="Password" hasError={errors.password} />
        </div>
